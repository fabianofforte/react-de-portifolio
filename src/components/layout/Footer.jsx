...
const Footer = () => {
  ...
  return (
    <footer className="relative bg-black overflow-hidden border border-white/10">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <FadeIn delay={200}>
            <div>
              <h4 className="text-white font-semibold mb-6 text-lg">Conecte-se Comigo</h4>
              <p className="text-white/60 text-sm mb-6 leading-relaxed">Vamos nos conectar e construir algo incrível juntos?</p>
