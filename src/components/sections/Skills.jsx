        ...
        <FadeIn delay={100}>
            <div className="text-center mb-16">
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 border border-primary/30 rounded-full mb-6">
                    ...
                    <span className="text-sm text-primary font-medium">Minha Experiência</span>
                </div>
                <h2 className="text-4xl lg:text-5xl font-normal text-white mb-4">
                    Habilidades e Tecnologias
                </h2>
                <p className="text-lg text-white/60 max-w-2xl mx-auto">
                    Visão geral das minhas habilidades técnicas e níveis de proficiência
                </p>
            </div>
        </FadeIn>
        {/* Skills Categories */}
                ...
                <FadeIn key={category} delay={categoryIndex * 100}>
                   <div className="relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300 group">
                        <div className="flex items-center gap-3 mb-6 pb-4 border-b border-white/10">
                            <div className="w-1 h-8 bg-linar-to-b from-primary/30 to-primary/10 rounded-full"></div>
                                    ...
                                    <div key={skill.id} className="space-y-2">
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center gap-3">
                                                <div className="p-2 bg-white/5 rouded-lg">
