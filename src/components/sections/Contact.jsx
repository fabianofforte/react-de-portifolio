   ...
   const socialIcons = {
    ...
    <section id="contact" className="relative py-20 bg-black overflow-hidden">
        <div className="absolute inset-0 overflow-hidden">
            ...
            <div className="absolute top-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-primary/10 opacity-30 rounded-full blur-3xl" />
        </div>
            ...
            <FadeIn delay={0}>
                <div className="text-center mb-16">
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 border border-primary/30 rounded-full mb-6">
                        ...
                        <span className="text-sm text-primary font-medium tracking-wider uppercase">Entre em Contato</span>
                    </div>
                    <h2 className="text-4xl lg:text-5xl font-normal text-white mb-4">Vamos Trabalhar Juntos</h2>
                    <p className="text-lg text-white/60 max-w-2xl mx-auto">
                        Tem um projeto em Mente? Vamos conversar sobre como Podemos dar Vida às suas Ideias.
                    </p>
                </div>
            </FadeIn>
                    ...
                    <div className="bg-white/5 border border-white/10 rounded-2xl p-8">
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div>
                                ...
                                <textarea id="message" name="message" value={formData.message} onChange={handleChange} rows={5} className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary/50 transition-all duration-300 resize-none" placeholder="Fale-me sobre o seu Projeto..." />
                            </div>
                    ...
                    <div className="space-y-8">
                        <div>
                            ...
                            <p className="text-white/60 leading-relaxed">                                
                                Estou sempre aberto a discutir novos projetos, ideias criativas ou oportunidades de fazer parte da sua visão. Fique à vontade para entrar em contato!
                            </p>
                        </div>
