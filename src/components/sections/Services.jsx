        ...
        <FadeIn delay={0}>
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 border border-primary/30 rounded-full mb-6">
              ...
              <span className="text-sm text-primary font-medium tracking-wider uppercase">Projetos em Destaque</span>
            </div>
            <h2 className="text-4xl lg:text-5xl font-normal text-white mb-4 max-w-2xl mx-auto">
              Desenvolvimento web estratégico + UX/UI que converte.
            </h2>
            <p className="text-lg text-white/60 max-w-xl mx-auto">
              Soluções completas para transformar suas ideias em experiências digitais excepcionais.
            </p>
          </div>
        </FadeIn>
